...
/**
 * Servlet implementation class courseListADMIN
 */
@WebServlet("/courseListADMIN")
public class courseListADMIN extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public courseListADMIN() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/courseListADMIN.jsp").forward(request, response);
    }
